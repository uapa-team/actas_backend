...
class REINPRE():
    ...
    def case_REINGRESO_PREGRADO(request, docx, redirected=False):
        ...
        para.add_run(
            '. Si el estudiante no renueva su matrícula en el semestre de reingreso, ')
        para.add_run(
            'el acto académico expedido por el Consejo de Facultad queda ')
        para.add_run(
            'sin efecto. (Resolución 012 de 2014 de Vicerrectoría Académica; Artículo ')
        para.add_run(
            '46, Acuerdo 008 de 2008 del Consejo Superior Universitario).\n')
        ...
        cellp.add_run(
            'Normativa Asociada: Articulo 46 del Acuerdo 008 de 2008 del CSU')
