...
class Request(DynamicDocument):
    ...
    TYPE_CHOICES = (
        (TYPE_TRASLADO_PREGRADO, 'Traslado'),
        (TYPE_REINGRESO_PREGRADO, 'Reingreso'),
        (TYPE_REEMBOLSO_PREGRADO, 'Reembolso'),
        (TYPE_CONCEPTO_CSU_PREGRADO, 'Concepto CSU'),
        (TYPE_CAMBIO_DE_GRUPO_PREGRADO, 'Cambio de grupo'),
        (TYPE_TRABAJO_DE_GRADO_PREGADO, 'Trabajo de grado'),
        (TYPE_DOBLE_TITULACION_PREGRADO, 'Doble titulación'),
        (TYPE_CAMBIO_DE_TIPOLOGIA_PREGRADO, 'Cambio de tipología'),
        (TYPE_EXPEDICION_DE_RECIBO_PREGRADO, 'Expedición de recibo'),
        (TYPE_PRACTICA_ESTUDIANTIL_PREGRADO, 'Práctica estudiantil'),
        (TYPE_RECURSO_DE_APELACION_PREGRADO, 'Recurso de apelación'),
        (TYPE_RECURSO_DE_REPOSICION_PREGRADO, 'Recurso de reposición'),
        (TYPE_DEVOLUCION_DE_CREDITOS_PREGRADO, 'Devolución de créditos'),
        (TYPE_HOMOLOGACION_DE_IDIOMA_PREGRADO, 'Homologación de idioma'),
        (TYPE_DESISTIMIENTO_MOVILIDAD_PREGRADO, 'Desistimiento movilidad'),
        (TYPE_CREDITOS_EXCEDENTES_MAPI_PREGRADO, 'Créditos excedentes MAPI'),
        (TYPE_MODIFICACION_DE_DECISION_PREGRADO, 'Modificación de decisión'),
        (TYPE_RESERVA_DE_CUPO_ADICIONAL_PREGRADO, 'Reserva de cupo adicional'),
        (TYPE_CANCELACION_DE_ASIGNATURAS_PREGRADO, 'Cancelación de asignaturas'),
        (TYPE_CARGA_INFERIOR_A_LA_MINIMA_PREGRADO, 'Carga inferior a la mínima'),
        (TYPE_INSCRIPCION_DE_ASIGNATURAS_PREGRADO, 'Inscripción de asignaturas'),
        (TYPE_RETIRO_DEFINITIVO_DEL_PROGRAMA_PREGRADO, 'Retiro definitivo del programa'),
        (TYPE_CANCELACION_DE_PERIODO_ACADEMICO_PREGRADO, 'Cancelación de periodo académico'),
        (TYPE_REGISTRO_DE_CALIFICACION_DE_MOVILIDAD_PREGRADO, 'Registro de calificación de movilidad'),
        (TYPE_HOMOLOGACION_CONVALIDACION_EQUIVALENCIA_PREGRADO, 'Homologación, convalidación y equivalencia'),
        (TYPE_ELIMINACION_DE_LA_HISTORIA_ACADEMICA_BAPI_PREGRADO, 'Eliminación de la historia académica BAPI'),
        (TYPE_RECURSO_DE_REPOSICION_CON_SUBSIDIO_DE_APELACION_PREGRADO, 'Recurso de reposición con subsidio de apelación'),
        (TYPE_DEVOLUCION_PROPORCIONAL_DEL_VALOR_PAGADO_POR_CONCEPTO_DE_DERECHOS_DE_MATRICULA_PREGRADO, 'Devolución proporcional del valor pagado por concepto de derechos de matrícula'),
        (TYPE_TRASLADO_POSGRADO, 'Traslado'),
        (TYPE_REEMBOLSO_POSGRADO, 'Reembolso'),
        (TYPE_REINGRESO_POSGRADO, 'Reingreso'),
        (TYPE_APOYO_ECONOMICO_POSGRADO, 'Apoyo económico'),
        (TYPE_CAMBIO_DE_GRUPO_POSGRADO, 'Cambio de grupo'),
        (TYPE_CAMBIO_DE_PERFIL_POSGRADO, 'Cambio de perfil'),
        (TYPE_CAMBIO_DE_TIPOLOGIA_POSGRADO, 'Cambio de tipología'),
        (TYPE_APROBACION_PASANTIA_POSGRADO, 'Aprobación pasantía'),
        (TYPE_BECA_MEJOR_PROMEDIO_POSGRADO, 'Beca mejor promedio'),
        (TYPE_ADMISION_AUTOMATICA_POSGRADO, 'Admisión automática'),
        (TYPE_EVALUADOR_ADICIONAL_POSGRADO, 'Evaluador adicional'),
        (TYPE_RECURSO_DE_REPOSICION_POSGRADO, 'Recurso de reposición'),
        (TYPE_CAMBIO_DE_PROYECTO_DE_TESIS, 'Cambio de proyecto de tesis'),
        (TYPE_TRANSITO_ENTRE_PROGRAMAS_POSGRADO, 'Tránsito entre programas'),
        (TYPE_DESIGNACION_DE_CODIRECTOR_POSGRADO, 'Designación de codirector'),
        (TYPE_RESERVA_DE_CUPO_ADICIONAL_POSGRADO, 'Reserva de cupo adicional'),
        (TYPE_CANCELACION_DE_ASIGNATURAS_POSGRADO, 'Cancelación de asignaturas'),
        (TYPE_INSCRIPCION_DE_ASIGNATURAS_POSGRADO, 'Inscripción de asignaturas'),
        (TYPE_INFORME_DE_AVANCE_DE_TESIS_POSGRADO, 'Informe de Avance de Tesis'),
        (TYPE_RETIRO_DEFINITIVO_DEL_PROGRAMA_POSGRADO, 'Retiro definitivo del programa'),
        (TYPE_EXCENCION_POR_MEJORES_SABER_PRO_POSGRADO, 'Exención por mejores SABER PRO'),
        (TYPE_CANCELACION_DE_PERIODO_ACADEMICO_POSGRADO, 'Cancelación de periodo académico'),
        (TYPE_GENERACION_DE_RECIBO_UNICO_DE_PAGO_POSGRADO, 'Generación de recibo único de pago'),
        (TYPE_MODIFICACION_DE_JURADOS_CALIFICADORES_POSGRADO, 'Modificación de jurados calificadores'),
        (TYPE_REGISTRO_DE_CALIFICACION_DE_MOVILIDAD_POSGRADO, 'Registro de calificación de movilidad'),
        (TYPE_HOMOLOGACION_CONVALIDACION_Y_EQUIVALENCIA_POSGRADO, 'Homologación, convalidación y equivalencia'),
        (TYPE_MODIFICACION_DE_OBJETIVOS_DE_TESIS_PROPUESTA_POSGRADO, 'Modificación de objetivos de tesis / propuesta'),
        (TYPE_RECURSO_DE_REPOSICION_CON_SUBSIDIO_DE_APELACION_POSGRADO, 'Recurso de reposición con subsidio de apelación'),
        (TYPE_CAMBIO_DE_DIRECTIOR_CODIRECTOR_JURADO_O_EVALUADOR_POSGRADO, 'Cambio de director, codirector, jurado o evaluador'),
        (TYPE_EXENCION_DE_PAGO_POR_CREDITOS_SOBRANTES_DE_PREGRADO_POSGRADO, 'Exención de pago por créditos sobrantes de pregrado'),
        (TYPE_AMPLIACION_DE_LA_FECHA_DE_PAGO_DE_DERECHOS_ACADEMICOS_POSGRADO, 'Ampliación de fecha de pago de derechos académicos'),
        (TYPE_APROBACION_PROYECTO_PROPUESTA_Y_DESIGNACION_DE_DIRECTOR_POSGRADO, 'Aprobación proyecto/propuesta y designación de director'),
        (TYPE_REGISTRO_DE_CALIFICACION_DEL_PROYECTO_Y_EXAMEN_DOCTORAL_POSGRADO, 'Registro de calificación del proyecto y examen doctoral'),
        (TYPE_DESIGNACION_DE_JURADOS_CALIFICADORES_DE_TESIS_TRABAJO_FINAL_POSGRADO, 'Designación de jurados calificadores de tesis/trabajo final'),
        (TYPE_EXENCION_DE_PAGO_POR_CURSAR_TESIS_COMO_UNICA_ACTIVIDAD_ACADEMICA_POSGRADO, 'Exención de pago por cursar tesis como única actividad académica'),
        (TYPE_DESIGNACION_DE_JURADOS_CALIFICADORES_DE_PROYECTO_DE_TESIS_DE_DOCTORADO_POSGRADO, 'Designación de jurados calificadores de proyecto de tesis de doctorado'),
    )
    ...
    APPROVAL_STATUS_RECOMIENDA = 'RC'
    APPROVAL_STATUS_NO_RECOMIENDA = 'NR'
    ...
    APPROVAL_STATUS_CHOICES = (
        ...
        (APPROVAL_STATUS_RECOMIENDA, 'Recomienda'),
        (APPROVAL_STATUS_NO_RECOMIENDA, 'No Recomienda'),
